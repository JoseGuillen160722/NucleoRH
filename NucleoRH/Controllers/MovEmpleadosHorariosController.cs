            ...
            try
            {
                if (meh != null)
                {
                    ...
                    if (Empleado != null)
                    {
                        ...
                        var Horario = _context.CatHorarios.Where(x => x.HoraEntrada == HELV && x.HoraSalida == HSLV && x.HoraSabadoEntrada == HES && x.HoraSabadoSalida == HSS && x.HoraComidaEntrada == HCSLV && x.HoraComidaSalida == HCELV && x.HoraSabadoComidaEntrada == HCES && x.HoraSabadoComidaSalida == HCSS).FirstOrDefault();
                        ...
                        var NuevoHorario = _context.CatHorarios.Where(x => x.HoraEntrada == HELV && x.HoraSalida == HSLV && x.HoraSabadoEntrada == HES && x.HoraSabadoSalida == HSS && x.HoraComidaEntrada == HCSLV && x.HoraComidaSalida == HCELV && x.HoraSabadoComidaEntrada == HCES && x.HoraSabadoComidaSalida == HCSS).FirstOrDefault();

...
namespace NucleoRH.Migrations
{
    ...
    [Migration("20220811161840_FKRegistroIncidenciasToCatEstatus")]
    partial class FKRegistroIncidenciasToCatEstatus
    {
            ...
            modelBuilder.Entity("NucleoRH.Models.CatRegistroIncidencias", b =>
                {
                    ...
                    b.HasOne("NucleoRH.Models.CatEstatus", "Estatus")
                        ...
                        .HasConstraintName("FK_registroIncidencias_cat_Estatus")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

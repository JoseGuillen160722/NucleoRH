...
namespace NucleoRH.Migrations
{
    ...
    [Migration("20221026135733_New column in HistorialVacaciones 2 new columns in Antiguedad")]
    partial class NewcolumninHistorialVacaciones2newcolumnsinAntiguedad
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NucleoRH.Models.CatUsuariosRolesPermisos", b =>
                {
                    ...
                    b.Property<int>("URPRoleId")
                        .HasColumnName("uRPRoleId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("cat_UsuariosRolesPermisos");
                });
            ...
            modelBuilder.Entity("NucleoRH.Models.CatUsuariosRolesPermisos", b =>
                {
                    b.HasOne("NucleoRH.Models.CatModulos", "Modulo")
                        .WithMany("UsuariosRolesPermisos")
                        .HasForeignKey("URPModuloId")
                        .HasConstraintName("FK_cat_UsuariosRolesPermisos_cat_Modulos")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NucleoRH.Models.CatSubModulos", "SubModulo")
                        .WithMany("CatUsuariosRolesPermisos")
                        .HasForeignKey("URPSubModuloId")
                        .HasConstraintName("FK_cat_UsuariosRolesPermisos_cat_SubModulos")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });

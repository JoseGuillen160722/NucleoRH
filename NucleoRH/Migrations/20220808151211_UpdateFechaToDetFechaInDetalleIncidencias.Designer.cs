...
namespace NucleoRH.Migrations
{
    ...
    [Migration("20220808151211_UpdateFechaToDetFechaInDetalleIncidencias")]
    partial class UpdateFechaToDetFechaInDetalleIncidencias
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NucleoRH.Models.DetalleIncidencias", b =>
                {
            ...
            modelBuilder.Entity("NucleoRH.Models.RegistroIncidencias", b =>
                {
            ...
            modelBuilder.Entity("NucleoRH.Models.DetalleIncidencias", b =>
                {
                    b.HasOne("NucleoRH.Models.CatHorarios", "Hora")
                        ...
                        .HasConstraintName("FK_detalleIncidencias_cat_Horarios")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NucleoRH.Models.RegistroIncidencias", "ReInci")
                        .WithMany("DetalleIncidencias")
                        .HasForeignKey("DetInciReInciId")
                        .HasConstraintName("FK_detalleIncidencias_registroIncidencias")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
